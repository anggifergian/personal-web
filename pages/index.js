        ...
        <section className='pb-20'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 gap-y-8'>
            {state.projects.map(item => (
              <div key={item.key}>
                <div className='mb-2 overflow-hidden rounded-lg dark:border-0 border-2 border-slate-200 border-opacity-40 hover:shadow-lg hover:border-opacity-0 transition ease-in-out duration-300'>
                  <Image
                    alt={item.key}
                    src={item.imagePath}
                    height={300}
